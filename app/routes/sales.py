...
def create_sale():
    ...
    if form.validate_on_submit():
        try:
            ...
            customer_name = Customer.query.get(customer_id).name if customer_id else 'Walk-in Customer'
            log_activity(
                current_user.id,
                'CREATE',
                'Sale',
    ...
    return render_template('sales/create_sale.html', title='Sales Entry', form=form, sales=sales, product_prices=product_prices)
